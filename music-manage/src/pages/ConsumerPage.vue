      ...
      <el-table-column type="selection" width="40"></el-table-column>
        <el-table-column label="用户图片" width="110" align="center">
          <template slot-scope="scope">
            ...
            <el-upload
              :action="uploadConsumerUrl(scope.row.id)"
    ...
    >
      ...
      <span class="dialog-footer" slot="footer">
        <el-button size="mini" @click="centerDialogVisible = false"
          >取 消</el-button
        >
        <el-button type="primary" size="mini" @click="addConsumer"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    <!-- 编辑弹出框 -->
    <el-dialog title="修改用户" :visible.sync="editVisible" width="400px" >
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
        ...
        <el-form-item prop="location" label="地区" size="mini">
          <el-input placeholder="地区" v-model="form.location">
          </el-input>
        </el-form-item>
      </el-form>
    ...
    addConsumer() {
      this.$refs['registerForm'].validate(valid =>{
        if(valid){
          ...
          params.append("avator", "/avatorImages/dengziqi.jpg");
         setConsumer(params)
            .then(res => {
              if (res.code == 1) {
               this.getData();
